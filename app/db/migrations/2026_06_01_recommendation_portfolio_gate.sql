...
-- vw_dashboard_command_center (created by migration 2) depends on
-- vw_daily_recommendation_board; it must be dropped first.
DROP VIEW IF EXISTS vw_dashboard_command_center CASCADE;
DROP VIEW IF EXISTS vw_daily_recommendation_board CASCADE;
DROP VIEW IF EXISTS vw_sector_performance CASCADE;
DROP VIEW IF EXISTS vw_recommendation_board CASCADE;
DROP VIEW IF EXISTS vw_model_health CASCADE;
