...
@click.option('--recommendation-profile', type=click.Choice(['steady_20p_10d', 'steady_20p_10d_v2']), default='steady_20p_10d', show_default=True, help='Recommendation profile for screening horizon')
